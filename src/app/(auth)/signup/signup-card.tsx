...
// import { Eye, EyeOff, Mail, Phone, TriangleAlert, User } from 'lucide-react';
...
// 			<Card className={cn('max-w-[350px] mx-auto w-full', !!error && 'border-rose-500')}>
// 				<CardHeader>
// 					<CardTitle>SignUp</CardTitle>
// 					<CardDescription>Docter</CardDescription>
// 				</CardHeader>
// 				<CardContent className='w-full flex flex-col gap-4 pb-2'>
// 					<form onSubmit={onSubmit} className='w-full flex flex-col gap-4'>
// 						<div className='w-full flex flex-col gap-2'>
// 							<Label htmlFor='input-10'>Name</Label>
...
// 									autoFocus
// 								/>
// 								<div className='pointer-events-none absolute inset-y-0 end-0 flex items-center justify-center pe-3 text-foreground peer-disabled:opacity-50'>
...
// 						</div>
// 						<div className='w-full flex flex-col gap-2'>
// 							<Label htmlFor='input-10'>Phone</Label>
// 							<div className='relative'>
// 								<Input
// 									id='phone'
// 									className='peer pe-9'
...
// 						</div>
// 						<div className='w-full flex flex-col gap-2'>
// 							<Label htmlFor='input-10'>Password</Label>
...
// 					{!!error && (
// 						<CardDescription className='text-red-500 text-center text-base flex items-center justify-center gap-2 '>
// 							<TriangleAlert /> Invalid SignUp, try again
// 						</CardDescription>
// 					)}

// 					<div className='w-full text-sm  mx-auto flex items-center justify-start '>
